...
def format_summary(summary: pd.DataFrame) -> pd.DataFrame:
    ...
    formatted["value"] = [
        fmt(m, v) for m, v in zip(summary["metric"], summary["value"], strict=False)
    ]
    return formatted
...
def main(argv: list[str] | None = None) -> None:
    ...
    print("=== Summary ===")
    for metric, value in zip(summary["metric"], summary["value"], strict=False):
