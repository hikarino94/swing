...
class EnvironmentSetup:
    ...
    def create_virtual_environment(self) -> None:
        ...
        subprocess.run([self.python_executable, "-m", "venv", str(self.venv_dir)], check=True)
        print("✓ 仮想環境を作成しました")
    ...
    def setup_config_files(self) -> None:
        ...
        self._setup_single_config(
            ...
            "screening/thresholds.json.example"
        )
    ...
    def setup_precommit(self) -> None:
        ...
        try:
            subprocess.run([*pip_cmd, "show", "pre-commit"], 
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="開発環境を自動的にセットアップします"
    )
    parser.add_argument(
        "--skip-venv",
        action="store_true",
