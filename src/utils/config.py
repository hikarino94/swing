...
class ConfigManager:
    ...
    def load_idtoken(self) -> Dict[str, Any]:
        ...
        Returns:
            idTokenを含む辞書
        """
        return self.load_json("config/idtoken.json")
    ...
    def load_account(self) -> Dict[str, Any]:
        ...
        Returns:
            アカウント情報を含む辞書
        """
        return self.load_json("config/account.json")
    ...
    def load_login(self) -> Dict[str, Any]:
        ...
        Returns:
            ログイン情報を含む辞書
        """
        return self.load_json("config/login.json")
    ...
    def load_thresholds(self) -> Dict[str, Any]:
        ...
        Returns:
            閾値設定を含む辞書
        """
        return self.load_json("src/analysis/thresholds.json")
    ...
    def get_token(self) -> str:
        ...
        """
        data = self.load_json("config/idtoken.json")
    ...
    def get_account_info(self) -> Dict[str, str]:
        ...
        """
        data = self.load_json("config/account.json")
    ...
    def get_login_info(self) -> Dict[str, str]:
        ...
        try:
            # まずlogin.jsonを試す
            data = self.load_json("config/login.json")
            ...
            return {"username": account_data["mailaddress"], "password": account_data["password"]}
    ...
    def save_token(self, token: str) -> None:
        ...
        """
        path = self.base_path / "config/idtoken.json"
        try:
